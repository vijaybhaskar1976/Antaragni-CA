  ...
  return (
    <section className="relative w-full flex flex-col py-24 md:py-32 overflow-hidden border-t border-white/5">
      <GridContainer className="items-start">
        ...
        <div className="col-span-1 md:col-span-5 lg:col-span-6 flex flex-col pt-10">
          ...
          <hr className="w-16 border-t border-accent mb-8" />
        ...
        <div className="col-span-1 md:col-span-3 lg:col-span-6 relative mt-16 md:mt-0 min-h-[500px] flex items-center justify-center">
          ...
          <div className="relative w-full h-full max-h-[600px] bg-black/40 border border-white/5 rounded-sm overflow-hidden flex items-end justify-center pb-0">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-10 lg:px-20 mt-32">
        <div className="w-full grid grid-cols-2 md:grid-cols-5 border-t border-b border-white/5 py-12 md:py-16 gap-y-12 relative">
          ...
          <StatisticBlock 
            ...
            valueColor="red"
            labelColor="gray"
            className="items-center text-center col-span-1 border-r border-white/5"
          />
          ...
          <StatisticBlock 
            ...
            valueColor="red"
            labelColor="gray"
            className="items-center text-center col-span-1 md:border-r border-white/5"
          />
          ...
          <StatisticBlock 
            ...
            valueColor="red"
            labelColor="gray"
            className="items-center text-center col-span-2 md:col-span-1"
          />
